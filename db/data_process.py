...
def do_process_data():
    ...
    # 파일명 설정
    # json_path = os.path.join(data_dir, "/data/ev_yearly_stats.json")
    # csv_path = os.path.join(data_dir, "/data/ev_yearly_stats.csv")
    # output_path = os.path.join(data_dir, "/data/ev_yearly_stats_long.csv")
